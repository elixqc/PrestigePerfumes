...
// Fetch all categories and suppliers for filter dropdowns
    ...
    <div class="product-management-container">
        <div class="page-header">
            ...
            <div class="header-actions">
                <a href="additems.php" class="btn btn-primary">
            ...
            <form method="GET" class="filters-form">
                <div class="filters-grid">
                        ...
                        <select name="supplier" id="supplier" class="filter-select">
                            ...
                            <?php foreach ($suppliers as $supplier): ?>
                                <option value="<?php echo $supplier['supplier_id']; ?>"
                                    <?php echo ($supplier_filter == $supplier['supplier_id']) ? 'selected' : ''; ?>>
                    ...
                    <div class="filter-actions">
                        ...
                        <a href="manageproducts.php" class="btn btn-clear">
